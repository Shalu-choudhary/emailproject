# naive bayes based algo used- for text classification
from flask import Flask, render_template,url_for,request
import joblib

bow_obj=joblib.load("./models/bag_of_words.lb")
model=joblib.load("./models/BernoulliNB.lb")# best 
app=Flask(__name__)
...
def prediction():
    if request.method=="POST":
        ...
        # return label_dict[str(prediction)]  output show
        return render_template('output.html',output=label_dict[str(prediction)])

# text classification on two data -- sentiment data
